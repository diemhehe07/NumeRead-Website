  ...
  async function choose(choice, button) {
    ...
    if (correct) {
      ...
      if (feedbackMsg) {
        ...
        feedbackMsg.innerHTML = `<span style="color:#dc2626; font-weight:600;"><i class="fas fa-times-circle"></i> Best answer: "${item.answer}". Passage clue: "${item.evidence}".${tipNote}</span>`;
      }
